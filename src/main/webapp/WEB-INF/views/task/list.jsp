    ...
    $(function () {
        ...
        $calendar.fullCalendar({
            ...
            eventClick: function (calEvent, jsEvent, view) {
                ...
                _event = calEvent.data;
                $("#event_id").val(calEvent.data.id);
                $("#event_title").text(calEvent.data.title);
                $("#event_start").text(moment(calEvent.data.start).format("YYYY-MM-DD"));
                $("#event_end").text(moment(calEvent.data.end).format("YYYY-MM-DD"));
                if (calEvent.data.reminderTime) {
                    $("#event_remindtime").text(calEvent.data.reminderTime);
                } else {
